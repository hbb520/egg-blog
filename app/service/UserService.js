...
class UserService extends Service {
  ...
  async login(username, password) {
    ...
    const user = await this.UserModel.findOne({
      attributes: ['id', 'username', 'email', 'phone', 'role', 'nickname', 'avator', 'lives_in_city', 'introduction'],
      where: {
        username,
  ...
  async getUserInfo(userId) {
    const user = await this.UserModel.findOne({
      attributes: ['id', 'username', 'email', 'phone', 'question', 'avator', 'lives_in_city', 'introduction', 'role', 'createTime', 'updateTime', 'nickname'],
      where: {id: userId},
    });
